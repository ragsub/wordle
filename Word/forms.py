...
class GuessForm(forms.Form):
    ...
    l1_color = forms.CharField(initial='btn-light',widget=forms.HiddenInput())
    l2_color = forms.CharField(initial='btn-light',widget=forms.HiddenInput())
    l3_color = forms.CharField(initial='btn-light',widget=forms.HiddenInput())
    l4_color = forms.CharField(initial='btn-light',widget=forms.HiddenInput())
    l5_color = forms.CharField(initial='btn-light',widget=forms.HiddenInput())


class AlphabetForm(forms.Form):
    l_color = forms.CharField(required=False, initial='bg-light', widget=forms.HiddenInput())